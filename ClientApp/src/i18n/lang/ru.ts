...
export default {
	...
	layout: {
		...
		dashboardmnt:'Панель мониторинга',
		dashboard:'Приборная панель',
		tenantmnt:'Управление арендодаторами',
		customermnt:'Управление клиентами',
		usermnt:'Управление пользователями',
		producemnt:'Управление продуктом',
		producelist:'Список продуктов',
		devicemnt:'Управление утсройствами',
		devicelist:'Список устройств',
		devicegraph:'Конфигуратор шлюза',
		assetsmnt:'Управление активами',
		assetlist:'Список активов',
		alarmmnt:'Управление сигнализацией',
		alarmlist:'Список тревог',
		rulesmnt:'Обычная цепочка',
		flowlist:'Дизайнер',
		flowevents:'События',
		settingsmnt:'Настройки',
		dicgroupmnt:'Группировка словаря',
		dicmnt:'Словарь',
		i18nlist:'Интернационализация',
		certmnt:'Управление сертификатами',
		phone:'Телефон',
		mail:'Почта',
		country:'Страна',
		province:'Провинция',
		...
		historyTelemtry:'История телеметрии',
		alarm:'Тревога',
		rules:'Правила',
		rulesHistory:'История правил',
		map:'Карта',
		deviceDetails:'Данные устройства',
		createTime:'Время создания предупреждения',
		startTime:'Время начала',
		endTime:'Время окончания',
		clearTime:'Чистое время',
		continuousStartUpTime:'Непрерывное время запуска',
		waitingEndTime:'Ожидание окончания',
		alarmType:'Тип тревоги',
		alarmStatus:'Статус тревоги',
		'Please enter the alarm type:': 'Пожалуйста, введите тип тревоги:',
		'Please enter the alarm status:': 'Пожалуйста, выберите статус тревоги:',
		serverity:'Уровень тревоги',
		'Please enter the serverity':'Пожалуйста, выберите уровень тревоги',
		'sourceAlarmType':'Источник тревоги',
		'Please select the source of the cause':'Пожалуйста выберите источник тревоги',
		originatorId:'Источник тревоги',
		'Please select the object of interest':'Пожалуйста выберите объект тревоги',
		query:'Поиск',
		operation:'Операции',
	}
};
